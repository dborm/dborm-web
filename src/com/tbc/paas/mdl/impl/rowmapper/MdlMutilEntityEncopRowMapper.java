...
public class MdlMutilEntityEncopRowMapper implements RowMapper<List<Object>> {

	private List<SqlResultColumn> resultColumns;
	private Configure configure;

	public MdlMutilEntityEncopRowMapper(Configure configure,
	...
	public List<Object> mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		for (int index = 1; index <= resultColumns.size(); index++) {
			...
			if (sqlResultColumn.isExtended()) {
				...
				Map<String, Object> dynamicColumns = MdlUtil.getExtMap(entity, dynamicField);
		...
		rowResult.addAll(rowRustltMap.values());
